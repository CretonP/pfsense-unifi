...
require("/usr/local/pkg/unifi.inc");

if (!is_array($config['installedpackages']['unifi']['config'])) {
	$config['installedpackages']['unifi']['config'] = array();
}
$a_avahi = &$config['installedpackages']['unifi']['config'][0];
